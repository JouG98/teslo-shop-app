...
interface SeedProduct {
    ...
    inStock     : number;
    price       : number;
    sizes       : ValidSizes[]; // tallas de ropa
...
interface SeedUser {
    ...
    status      : boolean;
    google      : boolean;
    credential  : 'credentials' | 'github' | 'google' | 'facebook';   
}
...
interface SeedData {
    users: SeedUser[],
    products: SeedProduct[], // definicion de usuarios de pruebas
} 
    ...
    users:[
        {
            ...
            password: bcrypt.hashSync('flash123', 10),
            picture: 'https://e7.pngegg.com/pngimages/580/368/png-clipart-flash-wally-west-logo-the-cw-television-network-superhero-flash-superhero-logo.png',
            rol: 'client',
            status: true,
            google: false,
        ...
        },
        {
            ...
            password: bcrypt.hashSync('supergirl', 10),
            picture: 'https://w0.peakpx.com/wallpaper/255/756/HD-wallpaper-supergirl-tv-show-2016-supergirl-girls-tv-shows.jpg',
            rol: 'admin',
            status: true,
            google: false,
            credential: 'credentials',
